...
import com.dhavisoft.CB.dto.Admin_Login;
import com.dhavisoft.CB.dto.Admin_logss;
import com.dhavisoft.CB.util.HibernateUtil;

@Repository
public class Admin_Login_DAO extends HibernateUtil implements ModelDriven<Object>, SessionAware {
...

	{
		...
		try {
			...
			if (it.hasNext()) {
				...
				Admin_logss rr = new Admin_logss();
