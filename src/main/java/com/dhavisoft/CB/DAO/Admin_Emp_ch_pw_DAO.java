...
import com.dhavisoft.CB.dto.Admin_Emp_ch_pw;
import com.dhavisoft.CB.util.HibernateUtil;

@Repository
public class Admin_Emp_ch_pw_DAO extends HibernateUtil {

	@Autowired
	private SessionFactory sessionFactory;

	/**
	 * @param chpw Admin Can change Employee password
	 * @return
	 */

	public Admin_Emp_ch_pw changepw(Admin_Emp_ch_pw chpw) {
